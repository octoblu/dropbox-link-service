...
var cryptkey = crypto.createHash('sha256').update(process.env.TEXT_CRYPT_KEY || 'toosecure').digest();
var iv = new Buffer(process.env.TEXT_CRYPT_NONCE || 'fourisanoncense1');
